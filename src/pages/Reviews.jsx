...
//   return (
//     <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 bg-gradient-to-br from-indigo-100 to-purple-200">
//       {reviews.map((movie) => (
//         <div
//           key={movie.imdbID}
...
//       {reviews.length === 0 ? (
//         <div className="flex items-center justify-center h-full m-top-10 text-center">
